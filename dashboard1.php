...
//check_login();
//$ID = $_SESSION['USER_ID'];
$sql = "SELECT a.token_id, b.vertical_name, a.url, b.url, b.sysadm_owner, a.in_time, a.total_d_time, b.dw_status, a.token_sts, a.esc_status FROM esc_detail_tbl a, esc_Vertical_tbl b WHERE b.dw_status = 0 and b.vertical_id = a.vertical_id";
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
   ...
   <td height="30"><span class="style10"><font color="#FFFFFF"><marquee direction="right" align="center" behavior="alternate" style="border:WHITE 3px SOLID">    Notification Dashboard    </marquee></font></span></td>
        </tr>
        </table>
        <tr>
...
<?php echo $_SESSION['name_of_user'];?> | <a href="escreport.php">Escalation Report</a>  | <a href="#" onClick="window.location.reload(true);">Refresh</a> | <a href="logout.php">Logout</a>&nbsp;&nbsp;</span></td>
                <td>&nbsp;</td>
                <td align="right"> <?php
                ...
                <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#E6EEEE" id="myTable" class="tablesorter">
                    <thead>
                      <tr bgcolor="#D7D7D7">
                        ...
                        <th width="8%"><div align="center" class="style47"><span class="style9">DOWN TIME (MM:SEC)</span></div></th>
                    ...
                    <tr height="30">
                        ...
                        <td><div align="center" class="style46"><span class="style9"><?php echo $rows['total_d_time'];?></span></div></td>
                        ...
                        <td><div align="center" class="style46">
                         <a href="javascript:;" onClick="MM_openBrWindow('mail-done.php?ID=<?php echo $rows['token_id']; ?>&VNAME=<?php echo $rows['VNAME']; ?>&NOTES=<?php echo $rows['NOTES']; ?>&ALERT=<?php echo $rows['SERVICE']; ?>','','width=700,height=300,,resizable=no,scrollbars=no,toolbar=no,location=no,directories=no,status=no')"><btn2 type="submit" value=""></btn2></a>
                         </td>
                    </div>
                    </td>
