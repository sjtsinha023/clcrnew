...
if ($rowsV['esc_status'] == "L2" or $rowsV['esc_status'] == "L3" ) {
    echo "escalation already done to level "; echo $rowsV['esc_status'];echo "..!";
    exit();
}
...
$to= $rowsN['esc_l1'];
$var = array($rowsN['esc_l1'], $rowsN['esc_l2']);
$to = $var[0]+","+$var[1];
$msg = $_POST["msg"];
$headers = "From: TechSupport";
$vname = $_POST["vname"];
mail($to,$subject,$msg,$headers);
echo "Email successfully sent.";
$sqlU = "UPDATE esc_detail_tbl SET esc_l2='".$var[0].",".$var[1]."', esc_status='L2' WHERE token_id='".$ID."'";
...
<tr>
  ...
  <td><label name="email"><?php echo $rowsN['esc_l1']; ?>,<?php echo $rowsN['esc_l2']; ?></label></td>
</tr>
<tr>
